...
def get_chat_ui():
    ...
    ui_messages = {
        ...
        "hu": {
            "welcome": f"{agent_avatar} Szia! {agent_name} vagyok, a Home Assistant AI asszisztensed.",
            "provider_model": f"Provider: <strong>{provider_name}</strong> | Modell: <strong>{model_name}</strong>",
            "capabilities": "Tudok eszközöket vezérelni, automatizálásokat létrehozni és az okosotthonodat kezelni.",
            "vision_feature": "",
            "o4mini_tokens_hint": "ℹ️ Megjegyzés: az o4-mini ~4000 token limittel rendelkezik. A kontextus és előzmények automatikusan csökkentve lesznek.",
            "analyzing": analyzing_msg
        }
    }
    ...
    ui_js_all = {
        ...
        "hu": {
            "change_model": "Modell váltás",
            "nvidia_test_title": "Gyors NVIDIA teszt (néhány másodpercig tarthat)",
            "nvidia_test_btn": "NVIDIA teszt",
            "new_chat_title": "Új beszélgetés",
            "new_chat_btn": "Új chat",
            "conversations": "Beszélgetések",
            "drag_resize": "Húzd az átméretezéshez",
            "remove_image": "Kép eltávolítása",
            "upload_image": "Kép feltöltése",
            "input_placeholder": "Írj egy üzenetet...",
            "image_too_large": "A kép túl nagy. Max 5MB.",
            "restore_backup": "Biztonsági mentés visszaállítása",
            "restore_backup_title": "Biztonsági mentés visszaállítása (pillanatkép: {id})",
            "confirm_restore": "Visszaállítod a biztonsági mentést? Ez visszavonja az utolsó változtatást.",
            "restoring": "Visszaállítás...",
            "restored": "Visszaállítva",
            "backup_restored": "Biztonsági mentés visszaállítva. Ha szükséges, frissítsd a Lovelace oldalt vagy ellenőrizd az automatizálást/scriptet.",
            "restore_failed": "Visszaállítás sikertelen.",
            "error_restore": "Visszaállítási hiba: ",
            "copy_btn": "Másolás",
            "copied": "Másolva!",
            "request_failed": "Kérés sikertelen ({status}): {body}",
            "rate_limit_error": "Sebességlimit túllépve. Kérlek várj egy pillanatot.",
            "unexpected_response": "Váratlan válasz a szervertől.",
            "error_prefix": "Hiba: ",
            "connection_lost": "Kapcsolat megszakadt. Próbáld újra.",
            "messages_count": "üzenet",
            "delete_chat": "Chat törlése",
            "no_conversations": "Nincsenek beszélgetések",
            "confirm_delete": "Törlöd ezt a beszélgetést?",
            "select_agent": "Válassz egy agentet a felső menüből. Bármikor válthatod.",
            "nvidia_tested": "Tesztelve",
            "nvidia_to_test": "Tesztelendő",
            "no_models": "Nincsenek elérhető modellek",
            "models_load_error": "Hiba a modellek betöltésekor: ",
            "nvidia_test_result": "NVIDIA teszt: OK {ok}, eltávolítva {removed}, tesztelve {tested}/{total}",
            "nvidia_remaining": "hátralévő: {n} (nyomd meg újra a folytatáshoz)",
            "nvidia_test_failed": "NVIDIA teszt sikertelen",
            "switched_to": "Átváltva: {provider} \u2192 {model}",
            "provider_label": "Provider",
            "model_label": "Modell",
            "web_html_warn": "⚠️ Nem hivatalos web provider: a HTML dashboard létrehozás hiányos vagy hibás lehet. Mindig ellenőrizd a generált fájlt.",
            # Suggestions
            "sug_lights": "Összes lámpa",
            "sug_sensors": "Szenzor állapot",
            "sug_areas": "Szobák és zónák",
            "sug_temperature": "Hőmérséklet előzmények",
            "sug_scenes": "Elérhető jelenetek",
            "sug_automations": "Automatizálások listája",
            # Read-only mode
            "readonly_title": "Csak olvasható mód: kód megjelenítése végrehajtás nélkül",
            "readonly_on": "BE",
            "readonly_off": "KI",
            "readonly_label": "Csak olvasható",
            # Confirmation buttons
            "confirm_yes": "Igen, megerősítem",
            "confirm_no": "Nem, mégsem",
            "confirm_yes_value": "igen",
            "confirm_no_value": "nem",
            "confirm_delete_yes": "Törlés",
            "today": "Ma",
            "yesterday": "Tegnap",
            "days_ago": "{n} napja",
            "sending_request": "Kérés küldése",
            "connected": "Csatlakozva",
            "waiting_response": "Várakozás a válaszra",
            "remove_document": "Dokumentum eltávolítása",
            "file_too_large": "Fájl túl nagy (max 10MB)",
            "uploading_document": "Dokumentum feltöltése...",
            "upload_failed": "Feltöltés sikertelen",
            "upload_error": "Feltöltési hiba",
            "unknown_error": "Ismeretlen hiba",
            "document_uploaded": "Dokumentum feltöltve",
            "mic_not_supported": "A böngésző nem támogatja a hangfelvételt. Használj HTTPS-t vagy kompatibilis böngészőt.",
            "mic_needs_https": "A mikrofon HTTPS-t igényel. Gyors javítás Chrome-ban: nyisd meg a chrome://flags/#unsafely-treat-insecure-origin-as-secure, add hozzá a HA címed (pl. http://192.168.x.x:8123), állítsd Enabled-re, indítsd újra a Chrome-ot.",
            "mic_denied_settings": "Mikrofon hozzáférés megtagadva. Engedélyezd a böngésző beállításokban.",
            "mic_denied_icon": "Mikrofon megtagadva. Kattints a 🔒 ikonra a böngésző címsorában az engedélyezéshez.",
            "mic_not_found": "Nem található mikrofon. Csatlakoztass egy mikrofont és próbáld újra.",
            "mic_in_use": "A mikrofont másik alkalmazás használja. Zárd be a többi alkalmazást és próbáld újra.",
            "mic_error": "Mikrofon hiba",
            # Voice mode
            "voice_mode": "Hang mód",
            "voice_listening": "Hallgatás...",
            "voice_processing": "Hang feldolgozása...",
            "voice_tts_no_provider": "Hangkimenet nem elérhető. Edge TTS vagy Groq/OpenAI API kulcs szükséges.",
            "voice_transcription_error": "Átírás sikertelen. Próbáld újra.",
            "voice_speaking": "Beszél...",
            "voice_stop_speaking": "Beszéd leállítása",
            "wake_word_detected": "Amira aktiválva! Beszélj most...",
            # Sidebar tabs
            "tab_chat": "Chat",
            "tab_bubble": "Buborék",
            "tab_amira": "Kártya",
            "tab_backups": "Mentések",
            "tab_devices": "Buborék eszközök",
            "tab_messaging": "📱 Üzenetek",
            "tab_files": "\U0001f4c1 Fájlok",
            "files_loading": "Betöltés...",
            "files_empty": "Üres mappa",
            "files_error": "Betöltési hiba",
            "files_close_panel": "Fájl panel bezárása",
            "files_context_label": "Fájl kontextus:",
            "messaging_no_chats": "Még nincsenek üzenetváltások",
            "messaging_messages": "Üzenetek",
            "messaging_delete": "Törlés",
            "messaging_confirm_delete": "Törlöd ezt a csevegést?",
            "no_backups": "Még nincsenek biztonsági mentések",
            "restore": "Visszaállítás",
            "confirm_restore_backup": "Visszaállítod ezt a mentést? A jelenlegi fájl felülíródik.",
            "delete_backup": "Törlés",
            "confirm_delete_backup": "Véglegesen törlöd ezt a mentést?",
            "download_backup": "Letöltés",
            # Device manager
            "no_devices": "Még nincsenek regisztrált eszközök",
            "enable_device": "Engedélyezés",
            "disable_device": "Letiltás",
            "rename_device": "Átnevezés",
            "delete_device": "Törlés",
            "confirm_delete_device": "Véglegesen törlöd ezt az eszközt?",
            "device_deleted": "Eszköz törölve",
            "device_updated": "Eszköz frissítve",
            # Dark mode
            "dark_mode": "Sötét mód",
            # Skills tab
            "tab_skills": "🧩 Skillek",
            "skills_installed": "Telepített",
            "skills_store": "Áruház",
            "skills_install_btn": "Telepítés",
            "skills_installed_badge": "Telepítve",
            "skills_delete_btn": "Eltávolítás",
            "skills_delete_confirm": "Eltávolítod ezt a skillt?",
            "skills_empty": "Nincsenek telepített skillek. Böngészd az áruházat lent.",
            "skills_store_empty": "Nincsenek elérhető skillek az áruházban.",
            "skills_store_loading": "Áruház betöltése...",
            "skills_store_error": "Nem sikerült betölteni az áruházat. Ellenőrizd az internetkapcsolatot.",
            "skills_unavailable": "Skillek nem elérhetők. Kérlek indítsd újra az addont.",
            "skills_update_banner": "Skill frissítés elérhető:",
            "skills_update_go": "Ugrás a Skillekhez",
            "skills_update_btn": "Frissítés",
            "skill_mode_hint": "Nyiss új chatet a témaváltáshoz",
            "skills_refresh": "Frissítés",
            "skills_by": "készítette",
            "skills_requires_version": "Amira v{version} szükséges",
            "skills_hint": "Írd be a /skill-név parancsot a chatbe a skill használatához",
            # Costs tab
            "tab_costs": "Költségek",
            "costs_today": "Ma",
            "costs_by_model": "Modell szerint",
            "costs_by_provider": "Provider szerint",
            "costs_history": "Utolsó 7 nap",
            "costs_no_data": "Még nincsenek használati adatok",
            "costs_reset": "Visszaállítás",
            "costs_reset_confirm": "Visszaállítod az összes használati statisztikát? Ez nem vonható vissza.",
            "costs_requests": "kérés",
            # Config tab
            "tab_config": "\U0001f527 Konfig",
            "config_loading": "Betöltés...",
            "config_save": "Mentés",
            "config_cancel": "Mégse",
            "config_saved": "Mentve!",
            "config_save_error": "Mentés sikertelen",
            "config_file_not_found": "Fájl nem található (mentéskor létrejön)",
            "config_agents_title": "Agent profilok",
            "config_mcp_title": "MCP konfiguráció",
            "config_prompt_title": "Egyéni rendszer prompt",
            "config_memory_title": "Memória (MEMORY.md)",
            "config_llm_title": "LLM prioritás",
            "config_model_cache_title": "Modell gyorsítótár",
            "llm_fallback_label": "Automatikus tartalék",
            "llm_priority_label": "Prioritási sorrend",
            "llm_no_key": "nincs kulcs",
            "llm_saved": "Mentve!",
            "llm_fallback_on": "Ha az elsődleges provider meghibásodik, a rendszer a következőt próbálja a listáról.",
            "llm_fallback_off": "Tartalék kikapcsolva. Csak az elsődleges provider lesz használva.",
            "fallback_notice": "Tartalék: {{from}} → {{to}}",
            # Settings
            "config_settings_title": "Beállítások",
            "settings_saved": "Beállítások mentve!",
            "settings_clear_models_cache": "Modell gyorsítótár törlése",
            "settings_clear_models_cache_confirm": "Törlöd a dinamikus provider modellek gyorsítótárát? A fix modellek elérhetők maradnak.",
            "settings_clear_models_cache_done": "Modell gyorsítótár törölve!",
            "settings_clear_models_cache_error": "Nem sikerült törölni a modell gyorsítótárat",
            "settings_refresh_models_cache": "Modell gyorsítótár frissítése",
            "settings_refresh_models_cache_done": "Modell gyorsítótár frissítve!",
            "settings_refresh_models_cache_error": "Nem sikerült frissíteni a modell gyorsítótárat",
            "settings_model_cache_title": "Modell gyorsítótár",
            "settings_model_cache_loading": "Modell gyorsítótár betöltése...",
            "settings_model_cache_updated_at": "Frissítve",
            "settings_model_cache_fixed": "Fix modellek",
            "settings_model_cache_dynamic": "Dinamikus modellek (gyorsítótár)",
            "settings_model_cache_blocklist": "Blokkolt modellek",
            "settings_model_cache_uncertain": "Bizonytalan teszteredmények",
            "settings_model_cache_nvidia_tested": "NVIDIA tesztelve OK",
            "settings_model_cache_empty": "Nincsenek modellek",
            "restart_confirm": "Néhány változtatás újraindítást igényel. Újraindítod az addont most?",
            "restart_in_progress": "Addon újraindítása...",
            "restart_failed": "Újraindítás sikertelen",
            "settings_language": "Nyelv",
            "settings_interaction_mode": "Interakciós stílus",
            "settings_enable_memory": "Memória",
            "settings_enable_file_access": "Fájl hozzáférés",
            "settings_enable_file_upload": "Fájl feltöltés",
            "settings_enable_voice_input": "Hang bemenet",
            "settings_enable_rag": "RAG",
            "settings_enable_chat_bubble": "Chat buborék",
            "settings_enable_amira_card_button": "Amira kártya gomb",
            "settings_enable_amira_automation_button": "Amira automatizálás gomb",
            "settings_enable_mcp": "MCP szerverek",
            "settings_fallback_enabled": "Automatikus tartalék",
            "settings_anthropic_thinking": "Anthropic gondolkodás",
            "settings_anthropic_caching": "Prompt gyorsítótárazás",
            "settings_openai_thinking": "OpenAI gondolkodás",
            "settings_nvidia_thinking": "NVIDIA gondolkodás",
            "settings_tts_voice": "TTS hang",
            "settings_enable_telegram": "Telegram",
            "settings_telegram_token": "Telegram Bot Token",
            "settings_telegram_allowed_ids": "Engedélyezett felhasználó ID-k",
            "settings_enable_whatsapp": "WhatsApp",
            "settings_twilio_sid": "Twilio Account SID",
            "settings_twilio_token": "Twilio Auth Token",
            "settings_twilio_from": "WhatsApp feladó szám",
            "settings_enable_discord": "Discord",
            "settings_discord_token": "Discord Bot Token",
            "settings_discord_allowed_channels": "Engedélyezett csatorna ID-k",
            "settings_discord_allowed_users": "Engedélyezett felhasználó ID-k",
            "settings_timeout": "Időtúllépés (mp)",
            "settings_max_retries": "Max újrapróbálkozás",
            "settings_max_conversations": "Max beszélgetések",
            "settings_max_snapshots": "Max pillanatkép/fájl",
            "settings_cost_currency": "Pénznem",
            "settings_section_language": "Nyelv",
            "settings_section_features": "Funkciók",
            "settings_section_ai": "AI",
            "settings_section_voice": "Hang",
            "settings_section_messaging": "Üzenetek",
            "settings_section_advanced": "Haladó",
            "settings_section_costs": "Költségek",
            # Settings descriptions
            "settings_desc_language": "AI válasz nyelve (angol, olasz, spanyol, francia vagy magyar)",
            "settings_desc_interaction_mode": "Strict = több biztonsági kérdés, Lean = közvetlenebb, természetesebb beszélgetés",
            "settings_desc_enable_memory": "[KÍSÉRLETI] Állandó memória – az AI csak azt jegyzi meg, amit a MEMORY.md-be írsz. Korábbi beszélgetések SOHA nem kerülnek a promptba.",
            "settings_desc_enable_file_access": "AI számára engedélyezett Home Assistant konfigurációs fájlok olvasása/írása (automatizálások, scriptek, YAML)",
            "settings_desc_enable_file_upload": "[KÍSÉRLETI] Dokumentumok feltöltésének engedélyezése (PDF, DOCX, TXT, MD, YAML) AI elemzéshez",
            "settings_desc_enable_voice_input": "Mikrofon gomb engedélyezése hangüzenetekhez (Groq Whisper, OpenAI/Google tartalékkal) – HTTPS szükséges",
            "settings_desc_enable_rag": "[KÍSÉRLETI] RAG (Retrieval-Augmented Generation) engedélyezése dokumentum kereséshez és kontextus beillesztéshez",
            "settings_desc_enable_chat_bubble": "Lebegő AI chat buborék megjelenítése minden HA oldalon.",
            "settings_desc_enable_amira_card_button": "Amira gomb megjelenítése a Lovelace kártya szerkesztőben az AI-segített kártya szerkesztéshez.",
            "settings_desc_enable_amira_automation_button": "Amira gomb és folyamatábra segéd megjelenítése a Home Assistant automatizálás szerkesztőben.",
            "settings_desc_enable_mcp": "MCP (Model Context Protocol) támogatás engedélyezése. Kikapcsolva az Amira kihagyja az MCP szerver csatlakozásokat induláskor.",
            "mcp_config_path": "Konfigurációs fájl",
            "settings_desc_mcp_config_file": "MCP konfigurációs JSON fájl elérési útja",
            "settings_desc_fallback_enabled": "Ha az elsődleges provider meghibásodik, automatikusan a következőt próbálja a prioritási listáról",
            "settings_desc_anthropic_extended_thinking": "Claude kiterjesztett gondolkodás engedélyezése összetett következtetési feladatokhoz (lassabb, több tokent használ)",
            "settings_desc_anthropic_prompt_caching": "Hosszú ismétlődő utasítások gyorsítótárazása költségmegtakarításért és gyorsabb válaszokért",
            "settings_desc_openai_extended_thinking": "o1/o3 gondolkodási mód engedélyezése összetett problémamegoldáshoz (lassabb, több tokent használ)",
            "settings_desc_nvidia_thinking_mode": "Gondolkodási mód engedélyezése az AI következtetési folyamatának megjelenítéséhez (lassabb, de átláthatóbb)",
            "settings_desc_tts_voice": "Hang az AI beszédválaszokhoz – automatikusan a nyelvedhez igazítva (Edge TTS, ingyenes)",
            "settings_desc_enable_telegram": "Telegram bot engedélyezése vagy letiltása. Letiltva a bejövő üzenetek 503 hibával elutasítódnak.",
            "settings_desc_telegram_bot_token": "Telegram bot token a @BotFather-től – hagyd üresen a letiltáshoz",
            "settings_desc_telegram_allowed_ids": "Vesszővel elválasztott Telegram felhasználó ID-k, akik használhatják a botot (pl. 123456789,987654321). Üresen hagyva mindenki használhatja – nem ajánlott.",
            "settings_desc_enable_whatsapp": "WhatsApp (Twilio) bot engedélyezése vagy letiltása. Letiltva a bejövő webhookok 503 hibával elutasítódnak.",
            "settings_desc_twilio_account_sid": "Twilio Account SID a WhatsApp integrációhoz – a console.twilio.com-ról szerezhető be",
            "settings_desc_twilio_auth_token": "Twilio Auth Token a WhatsApp integrációhoz – a console.twilio.com-ról szerezhető be",
            "settings_desc_twilio_whatsapp_from": "Twilio WhatsApp szám (pl. +1234567890) – hagyd üresen a letiltáshoz",
            "settings_desc_enable_discord": "Discord bot engedélyezése vagy letiltása. Letiltva a bejövő Discord üzenetek figyelmen kívül maradnak.",
            "settings_desc_discord_bot_token": "Discord Bot token a Discord Developer Portalról – hagyd üresen a letiltáshoz",
            "settings_desc_discord_allowed_channel_ids": "Vesszővel elválasztott Discord csatorna ID-k, amelyek használhatják a botot. Üresen hagyva minden csatorna engedélyezett.",
            "settings_desc_discord_allowed_user_ids": "Vesszővel elválasztott Discord felhasználó ID-k, akik használhatják a botot. Üresen hagyva mindenki használhatja.",
            "settings_desc_timeout": "API kérés időtúllépés másodpercben (alapértelmezett 30, növeld ha a válaszok lassúak)",
            "settings_desc_max_retries": "Sikertelen API hívások maximális újrapróbálkozási száma (alapértelmezett 3)",
            "settings_desc_max_conversations": "Előzményekben tárolt beszélgetések maximális száma (1–100)",
            "settings_desc_max_snapshots_per_file": "Fájlonkénti maximális biztonsági mentés pillanatképek. A legrégebbiek automatikusan törlődnek a limit elérésekor.",
            "settings_desc_cost_currency": "Pénznem a token költség megjelenítéséhez",
            "models_group_fixed": "Fix",
            "models_group_dynamic_cache": "Dinamikus (gyorsítótár)",
            # Agent form
            "agent_add": "Új agent",
            "agent_new": "\U0001f916 Új agent",
            "agent_none": "Nincsenek konfigurált agentek. Kattints az \"Új agent\" gombra a kezdéshez.",
            "agent_back": "Vissza",
            "agent_name": "Név",
            "agent_desc": "Leírás",
            "agent_tools": "Engedélyezett eszközök",
            "agent_enabled": "Engedélyezve",
            "agent_id_label": "ID (egyedi)",
            "agent_id_invalid": "Az ID csak kisbetűket, számokat, - és _ karaktereket tartalmazhat",
            "agent_sysprompt_label": "Agent utasítások",
            "agent_sysprompt_hint": "Opcionális utasítások az alapértelmezett rendszer prompt elé. Példa: A neved Jarvis. A felhasználó neve János.",
            "agent_delete_confirm": "Agent törlése",
            "agent_protected": "Védett (beépített)",
            "agent_fallbacks": "Tartalék modellek",
            "agent_temperature": "Hőmérséklet (0-2)",
            "agent_thinking": "Gondolkodás",
            "agent_maxtokens": "Max tokenek",
            "agent_default_flag": "Alapértelmezett",
            "agent_tools_hint": "üres = összes",
            # Agent form tooltips
            "tip_agent_id": "Egyedi azonosító. Használj kisbetűket, szóközök nélkül (pl. otthon, koder, energia).",
            "tip_agent_name": "Megjelenítési név az agent választóban.",
            "tip_agent_emoji": "Ikon az agent neve mellett.",
            "tip_agent_desc": "Rövid leírás, mire specializálódott ez az agent.",
            "tip_agent_provider": "AI provider (pl. Anthropic, OpenAI). Hagyd üresen az alapértelmezetthez.",
            "tip_agent_model": "Használandó modell. Hagyd üresen a provider alapértelmezettjéhez.",
            "tip_agent_fallbacks": "Vesszővel elválasztott tartalék modellek, ha az elsődleges nem elérhető.",
            "tip_agent_temperature": "Véletlenszerűség szabályozása (0=determinisztikus, 2=kreatív). Alapértelmezett: 0.7.",
            "tip_agent_thinking": "Következtetési mélység: off, low, medium, high, vagy adaptive.",
            "tip_agent_maxtokens": "Válaszonkénti maximális tokenszám. Alapértelmezett: 4096.",
            "tip_agent_sysprompt": "Az alapértelmezett HA rendszer prompt elé fűzött utasítások. Az AI megtartja a teljes HA kontextust az egyéni infóddal együtt.",
            "tip_agent_tools": "Válaszd ki, mely eszközöket használhatja ez az agent. Ha nincs kiválasztva = összes eszköz elérhető.",
            "tip_agent_default": "Az alapértelmezett agent kerül használatra, ha nincs konkrét agent kiválasztva.",
            "tip_agent_enabled": "Letiltott agentek rejtve vannak az agent választóból.",
            # MCP form
            "mcp_add_server": "Szerver hozzáadása",
            "mcp_server_name": "Szerver neve",
            "mcp_command": "Parancs",
            "mcp_args": "Argumentumok",
            "mcp_env": "Környezeti változók",
            "mcp_pip_section": "Pip csomagok telepítése",
            "mcp_install_btn": "Telepítés",
            "mcp_no_packages": "Nincsenek megadva csomagok.",
            "mcp_installing": "Telepítés...",
            "mcp_done": "Kész.",
            "mcp_error": "Hiba.",
            "mcp_start_failed": "MCP indítás sikertelen",
            "mcp_stop_failed": "MCP leállítás sikertelen",
            "mcp_no_servers": "Nincsenek konfigurált MCP szerverek. Kattints a \"Szerver hozzáadása\" gombra külső eszközök csatlakoztatásához.",
            "tip_mcp_name": "Egyedi név ehhez az MCP szerverhez (pl. filesystem, web_search).",
            "tip_mcp_command": "Parancs a szerver indításához (pl. python, uvx, npx).",
            "tip_mcp_args": "Soronként egy argumentum. Pl. -m, mcp.server.stdio.",
            "tip_mcp_env": "Soronként egy: KULCS=ÉRTÉK. A szerver környezeti változói.",
            # System prompt form
            "prompt_chars": "karakter",
            "prompt_reset": "Törlés",
            "prompt_hint": "Írj egyéni utasításokat ide. Ezek az alapértelmezett rendszer prompt elé kerülnek.\nPélda: A felhasználó neve Kovács János. Mindig magyarul válaszolj.",
            # Memory form
            "memory_hint": "Markdown jegyzetek, amelyeket az AI megjegyez a beszélgetések között...",
            "memory_lines": "sor",
            # Channel association
            "agent_channels": "Csatorna hozzárendelés",
            "agent_channel_telegram": "Telegram",
            "agent_channel_whatsapp": "WhatsApp",
            "agent_channel_discord": "Discord",
            "agent_channel_taken": "Már hozzárendelve",
            "tip_agent_channels": "Rendeld hozzá ezt az agentet egy üzenetküldő csatornához. Minden csatornához egy agent rendelhető.",
        },
    }
    ...
    _tool_descs_all = {
        ...
        "hu": {
            "update_automation": "Automatizálás módosítása",
            "get_automations": "Automatizálások betöltése",
            "trigger_automation": "Automatizálás indítása",
            "delete_automation": "Automatizálás törlése",
            "create_automation": "Automatizálás létrehozása",
            "get_available_services": "Elérhető szolgáltatások betöltése",
            "get_events": "Események betöltése",
            "get_history": "Előzmények betöltése",
            "get_scenes": "Jelenetek betöltése",
            "activate_scene": "Jelenet aktiválása",
            "get_scripts": "Scriptek betöltése",
            "run_script": "Script futtatása",
            "update_script": "Script módosítása",
            "create_script": "Script létrehozása",
            "delete_script": "Script törlése",
            "get_areas": "Szobák/zónák betöltése",
            "manage_areas": "Szobák/zónák kezelése",
            "manage_entity": "Entitás kezelése",
            "get_devices": "Eszközök betöltése",
            "send_notification": "Értesítés küldése",
            "get_dashboards": "Dashboardok betöltése",
            "create_dashboard": "Dashboard létrehozása",
            "delete_dashboard": "Dashboard törlése",
            "create_html_dashboard": "HTML dashboard létrehozása",
            "read_config_file": "Konfigurációs fájl olvasása",
            "write_config_file": "Konfigurációs fájl írása",
            "list_config_files": "Konfigurációs fájlok listázása",
            "manage_statistics": "Statisztikák kezelése",
            "get_entities": "Entitások betöltése",
            "get_entity_state": "Entitás állapot lekérdezése",
            "call_service": "Szolgáltatás hívása",
            "search_entities": "Entitások keresése",
            "get_integration_entities": "Integráció entitások keresése",
        },
    }
