...
LANGUAGE_TEXT = {
    "en": {
        ...
        "strict_language_lock": "ALWAYS reply in English, regardless of the language the user writes in. Never switch to another language, even if the user writes in Italian, Spanish, French, or any other language.",
    ...
    "it": {
        ...
        "strict_language_lock": "Rispondi SEMPRE in Italiano, indipendentemente dalla lingua in cui scrive l'utente. Non cambiare mai lingua, anche se l'utente scrive in inglese, spagnolo, francese o qualsiasi altra lingua.",
    ...
    "es": {
        ...
        "strict_language_lock": "Responde SIEMPRE en Español, sin importar el idioma en el que escriba el usuario. Nunca cambies de idioma, ni siquiera si el usuario escribe en inglés, italiano, francés o cualquier otro idioma.",
    ...
    "fr": {
        ...
        "strict_language_lock": "Réponds TOUJOURS en Français, quelle que soit la langue dans laquelle écrit l'utilisateur. Ne change jamais de langue, même si l'utilisateur écrit en anglais, italien, espagnol ou toute autre langue.",
